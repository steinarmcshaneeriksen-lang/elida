...
export function NoDataState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[var(--radius-lg)] border border-dashed border-border bg-surface px-6 py-16 text-center">
      <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-surface-hover shadow-[inset_0_0_0_1px_var(--border)]">
        <Database size={24} className="text-[var(--tone-ocean)]" />
      </div>
